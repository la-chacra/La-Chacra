...
-- Schema lachacra_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `lachacra_db_testing` DEFAULT CHARACTER SET utf8 ;
USE `lachacra_db_testing` ;

-- -----------------------------------------------------
-- Table `lachacra_db`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`usuario` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`productos_menu` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`comanda` (
  ...
  CONSTRAINT `fk_Comanda_Usuario1`
    ...
    REFERENCES `lachacra_db_testing`.`usuario` (`usuario_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`inventario` (
  ...
  `precio_unitario` INT UNSIGNED NULL,
  `activo` TINYINT NOT NULL DEFAULT '1',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`reserva` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`inventario_menu` (
  `insumo_id` INT NOT NULL,
  `producto_id` INT NOT NULL,
  `cantidad_necesaria` TINYINT UNSIGNED NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `fk_Inventario_has_Menu_Inventario1`
    ...
    REFERENCES `lachacra_db_testing`.`inventario` (`insumo_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventario_has_Menu_Menu1`
    FOREIGN KEY (`producto_id`)
    REFERENCES `lachacra_db_testing`.`productos_menu` (`producto_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`detalle_comanda` (
  ...
  CONSTRAINT `fk_Comanda_has_Menu_Comanda1`
    ...
    REFERENCES `lachacra_db_testing`.`comanda` (`comanda_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `lachacra_db`.`otp_codigos`
-- -----------------------------------------------------
CREATE TABLE `lachacra_db_testing`.`otp_codigos` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lachacra_db_testing`.`registro_actividades` (
