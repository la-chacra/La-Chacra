...
-- Schema lachacra_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `lachacra_db` DEFAULT CHARACTER SET utf8mb3 ;
USE `lachacra_db` ;
...
CREATE TABLE IF NOT EXISTS `lachacra_db`.`inventario` (
  ...
  `nombre` VARCHAR(45) NOT NULL,
  `categoria` VARCHAR(70) NULL DEFAULT NULL,
  `cantidad` DECIMAL(10,2) NOT NULL,
  `cantidad_minima` DECIMAL(10,2) NOT NULL,
  `unidad` VARCHAR(20) NULL DEFAULT NULL,
  `precio_unitario` INT UNSIGNED NULL DEFAULT NULL,
  `activo` TINYINT NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `lachacra_db`.`registro_actividades` (
  ...
  `valor_antes` JSON NULL DEFAULT NULL,
  `valor_despues` JSON NULL DEFAULT NULL,
