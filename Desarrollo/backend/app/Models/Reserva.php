...
class Reserva extends ModeloBase {
    ...
    /**
     * Realizar el registro de una reserva en la Base de Datos
     * 
     * @return bool Según se pudo realizar la operación o no
     */
     ...
     * 
     * @return bool Si la eliminación fue éxitosa o no
     */
