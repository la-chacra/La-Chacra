...
abstract class Usuario {
    ...
    public function __construct(protected string $nombre, protected string $apellido, protected string $correo, protected string $contrasena, protected DateTime $fecha_nacimiento) {
    }
